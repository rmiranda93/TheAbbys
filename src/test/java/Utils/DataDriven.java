...
public class DataDriven {
    ...
    public static ArrayList<String> getData(String nombreCasoPrueba)  {
        ...
        try {
            file = new FileInputStream(PropDriven.getProperty("rutaExcel"));
        ...
        for(int i=0; i < sheets;i++){
            if(excel.getSheetName(i).equalsIgnoreCase(PropDriven.getProperty("hojaExcel"))){
                //encontre la Hoja
                ...
                while(celdas.hasNext()){
                    ...
                    if(celdaSeleccionada.getStringCellValue().equalsIgnoreCase(PropDriven.getProperty("tituloCPs"))){
                        columna = k;
                    }
                    k++;
                }
